...
class Simulation:
    def __init__(self, num_agents, render=True, rgb_array=False, plate_image_path=None):
        self.render = render
        ...
        # Use custom plate image
            self.plate_image_path = plate_image_path
            self.textureId = p.loadTexture(plate_image_path)  # ← MUST load as texture!
        else:
        # Use random texture (original behavior)
            ...
            self.plate_image_path = f'textures/_plates/...'
